...
public class CriarCSVRedomeModificadoSemEvolucaoCaso {
	...
	public static void main(String[] args) throws IOException, ParseException, CsvDataTypeMismatchException, CsvRequiredFieldEmptyException {
		...
		SivepRedomeModificadoCSVHandler.criarCSV("./arquivos/csv/SIVEP_REDOME(Modificado-SemEvolucaoCaso).csv", registrosModificados);
	}
